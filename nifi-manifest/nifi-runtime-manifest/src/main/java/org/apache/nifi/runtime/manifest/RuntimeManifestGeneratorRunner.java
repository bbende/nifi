...
public class RuntimeManifestGeneratorRunner {
    ...
    public void execute(final File manifestBaseDir, final File manifestOutputFile) throws IOException {
        ...
        final RuntimeManifestSerializer runtimeManifestSerializer = new JacksonRuntimeManifestSerializer(objectWriter);

        final RuntimeManifestGenerator runtimeManifestGenerator =
