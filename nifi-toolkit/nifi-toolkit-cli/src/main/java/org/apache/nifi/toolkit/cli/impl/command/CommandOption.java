...
public enum CommandOption {
    ...
    // Registry - Extensions
    EXT_BUNDLE_BUCKET_NAME_FILTER("bnf", "bucketNameFilter", "An optional bucket name filter, supports wildcards with the '%' character", true),
    EXT_BUNDLE_GROUP_FILTER("gf", "groupFilter", "An optional group id filter, supports wildcards with the '%' character", true),
    EXT_BUNDLE_ARTIFACT_FILTER("af", "artifactFilter", "An optional artifact id filter, supports wildcards with the '%' character", true),
    ...
    EXT_BUNDLE_PATH("ebp", "extensionBundlePath", "The path to an extension bundle in the form 'bucketName::groupId::artifactId'", true),
    EXT_BUNDLE_VERSION("ebv", "extensionBundleVersion", "The version of the extension bundle", true),
