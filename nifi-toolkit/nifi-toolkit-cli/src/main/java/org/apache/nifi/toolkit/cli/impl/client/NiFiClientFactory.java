...
public class NiFiClientFactory implements ClientFactory<NiFiClient> {
    ...
    private static class ProxiedNiFiClient implements NiFiClient {
        ...
        public ParamContextClient getParamContextClient() {
            return wrappedClient.getParamContextClient(proxiedEntity);
        }

        @Override
        public ParamContextClient getParamContextClient(String... proxiedEntity) {
            return wrappedClient.getParamContextClient(proxiedEntity);
        }

        @Override
        public ParamContextClient getParamContextClient(String token) {
            return wrappedClient.getParamContextClient(token);
        }
