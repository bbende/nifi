...
public abstract class AbstractUpdateParamContextCommand<R extends Result> extends AbstractNiFiCommand<R> {
    ...
    protected ParameterContextUpdateRequestEntity performUpdate(final ParamContextClient client, final ParameterContextUpdateRequestEntity updateRequestEntity)
        ...
        try {
            ...
            for (int i = 0; i < 30; i++) {
                final ParameterContextUpdateRequestEntity retrievedUpdateRequest = client.getParamContextUpdateRequest(updateRequestId);
            ...
            final ParameterContextUpdateRequestEntity deleteUpdateRequest = client.deleteParamContextUpdateRequest(updateRequestId);
