...
public interface ParamContextClient {
    ...
    ParameterContextUpdateRequestEntity getParamContextUpdateRequest(String updateRequestId) throws NiFiClientException, IOException;

    ParameterContextUpdateRequestEntity deleteParamContextUpdateRequest(String updateRequestId) throws NiFiClientException, IOException;
