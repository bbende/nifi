 ...
 */
public class PGGetVersion extends AbstractNiFiCommand<VersionControlInformationEntity> {
    ...
    @Override
    protected Result<VersionControlInformationEntity> doExecute(final NiFiClient client, final Properties properties)
