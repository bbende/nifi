...
public abstract class AbstractKerberosUserService extends AbstractControllerService implements KerberosUserService {
    ...
    /**
     * Allow sub-classes to create the specific KerberosUser instance.
     *
     * Will be called from getKerberosUser, after @OnEnabled.
     *
     * @return a KerberosUser instance
     */
    protected abstract KerberosUser createKerberosUser();
