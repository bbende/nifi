...
public abstract class AbstractHadoopProcessor extends AbstractProcessor {
     ...
     */
    HdfsResources resetHDFSResources(final ResourceReferences resourceReferences, final ProcessContext context) throws IOException {
    ...
    private KerberosUser getKerberosUser(final ProcessContext context) throws IOException {
        ...
        if (kerberosUserService != null) {
            return kerberosUserService.getKerberosUser();
        }
