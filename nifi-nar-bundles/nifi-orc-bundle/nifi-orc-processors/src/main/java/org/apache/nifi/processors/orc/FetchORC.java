...
@Tags({"ORC", "hadoop", "HDFS", "get", "ingest", "fetch", "source", "restricted"})
@CapabilityDescription("Reads from a given ORC file and writes records to the content of the flow file using " +
