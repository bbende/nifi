...
public class StandardReportingTaskNode extends AbstractReportingTaskNode implements ReportingTaskNode {
    ...
    public StandardReportingTaskNode(final ReportingTask reportingTask, final String id, final FlowController controller,
        ...
        super(reportingTask, id, controller, processScheduler, validationContextFactory, variableRegistry, bundleCoordinate);
    ...
    public StandardReportingTaskNode(final ReportingTask reportingTask, final String id, final FlowController controller,
        ...
        super(reportingTask, id, controller, processScheduler, validationContextFactory, componentType, canonicalClassName,variableRegistry, bundleCoordinate, isExtensionMissing);
        this.flowController = controller;
    }
