...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        define(['jquery',
                ...
                'nf.ComponentVersion',
                'nf.PolicyManagement'],
            function ($, Slick, d3, client, dialog, common, canvasUtils, controllerServices, errorHandler, reportingTask, shell, componentState, componentVersion, policyManagement) {
                return (nf.Settings = factory($, Slick, d3, client, dialog, common, canvasUtils, controllerServices, errorHandler, reportingTask, shell, componentState, componentVersion, policyManagement));
            });
...
}(this, function ($, Slick, d3, client, dialog, common, canvasUtils, controllerServices, errorHandler, reportingTask, shell, componentState, componentVersion, policyManagement) {
    'use strict';
        ...
        reportingTasksGrid.onClick.subscribe(function (e, args) {
            ...
            if (reportingTasksGrid.getColumns()[args.cell].id === 'actions') {
                if (target.hasClass('edit-reporting-task')) {
                    ...
                    componentVersion.promptForVersionChange(reportingTaskEntity);
