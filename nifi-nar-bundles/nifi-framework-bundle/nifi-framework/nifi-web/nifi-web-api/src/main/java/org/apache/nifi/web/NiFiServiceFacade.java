...
public interface NiFiServiceFacade {
     ...
     */
    VersionedFlowSnapshot registerVersionedFlowSnapshot(String registryId, VersionedFlow flow, VersionedProcessGroup snapshot, Collection<VersionedParameterContext> parameterContexts, String comments,
                                                        int expectedVersion);
