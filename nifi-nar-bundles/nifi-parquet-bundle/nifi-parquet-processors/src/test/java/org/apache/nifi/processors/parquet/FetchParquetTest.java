...
public class FetchParquetTest {
    ...
    private void configure(final FetchParquet fetchParquet) throws InitializationException {
        ...
        final RecordSetWriterFactory writerFactory = new CSVRecordSetWriter();
        testRunner.addControllerService("csv-writer-factory", writerFactory);
        testRunner.enableControllerService(writerFactory);

        testRunner.setProperty(FetchParquet.RECORD_WRITER, "csv-writer-factory");
    }
    ...
    public void testFetchParquetToCSV() throws IOException, InitializationException {
        ...
        final String flowFileContent = new String(flowFile.toByteArray(), StandardCharsets.UTF_8);
    ...
    @Test
    public void testIOExceptionWhileWritingShouldRouteToRetry() throws InitializationException, IOException {
        configure(proc);
        ...
        when(recordSetWriterFactory.createWriter(any(ComponentLog.class))).thenReturn(recordSetWriter);
